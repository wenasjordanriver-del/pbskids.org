...
function setFlashVariables(movieid, flashquery){
	...
	if(is_pc_ie){
		...
		var divinfo = "<embed src='/PBS-Kids-2006/wordgirl/gateway.swf' FlashVars='lc="+movieid+"&fq="+escape(flashquery)+"' width='0' height='0' type='application/x-shockwave-flash'></embed>";
